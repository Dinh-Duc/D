            ...
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                <li class=" nav-item"><a class="d-flex align-items-center" href="index.html"><i data-feather="home"></i><span class="menu-title text-truncate" data-i18n="Dashboards">Dashboards</span><span class="badge badge-light-warning badge-pill ml-auto mr-1">2</span></a>
                    <ul class="menu-content">
                        <li><a class="d-flex align-items-center" href="articles"><i data-feather="circle"></i><span class="menu-item text-truncate" data-i18n="Analytics">Articles</span></a>
                        </li>
                        <li><a class="d-flex align-items-center" href="products"><i data-feather="circle"></i><span class="menu-item text-truncate" data-i18n="eCommerce">Products</span></a>
                        </li>
                    </ul>
                </li>
                            ...
                            <div class="table-responsive">
                                <table class="table table-sm">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                <img src="../../../app-assets/images/icons/angular.svg" class="mr-75" alt="Angular" width="18" height="18" />
                                                <span class="font-weight-bold">Angular Project</span>
                                            </td>
                                            <td>Peter Charls</td>
                                            <td>
                                        ...
                                        <tr>
                                            <td>
                                                <img src="../../../app-assets/images/icons/react.svg" class="mr-75" alt="React" width="18" height="18" />
                                                <span class="font-weight-bold">React Project</span>
                                            </td>
                                            <td>Ronald Frest</td>
                                            <td>
                                        ...
                                        <tr>
                                            <td>
                                                <img src="../../../app-assets/images/icons/vuejs.svg" class="mr-75" alt="Vuejs" width="18" height="18" />
                                                <span class="font-weight-bold">Vuejs Project</span>
                                            </td>
                                            <td>Jack Obes</td>
                                            <td>
                                        ...
                                        <tr>
                                            <td>
                                                <img src="../../../app-assets/images/icons/bootstrap.svg" class="mr-75" alt="Bootstrap" width="18" height="18" />
                                                <span class="font-weight-bold">Bootstrap Project</span>
                                            </td>
                                            <td>Jerry Milton</td>
                                            <td>
